...
public class Rajesh {
    ...
    public Rajesh(Integer ticketid, String from, String todes, int one, int two, int three, int four, int five, int six,
            int seven, int eight, int nine, int ten, int eleven, int tweleve, int thirteen, int forteen, int fifteen,
    ...
    public String toString() {
        return "Rajesh [ticketid=" + ticketid + ", from=" + from + ", todes=" + todes + ", one=" + one + ", two=" + two
                + ", three=" + three + ", four=" + four + ", five=" + five + ", six=" + six + ", seven=" + seven
                + ", eight=" + eight + ", nine=" + nine + ", ten=" + ten + ", eleven=" + eleven + ", tweleve=" + tweleve
                + ", thirteen=" + thirteen + ", forteen=" + forteen + ", fifteen=" + fifteen + ", sixteen=" + sixteen
                + ", seventeen=" + seventeen + ", eightteen=" + eightteen + ", nineteen=" + nineteen + ", twenty="
                + twenty + ", date=" + date + "]";
    }
